...
import com.clarabridge.com.devmarvel.creditcardentry.internal.CreditCardFieldDelegate;
...
public abstract class CreditEntryFieldBase extends EditText implements
    ...
    void init(AttributeSet attrs) {
        ...
        setPadding((int) DpVisitor.toPixels(context, 7), 0, (int) DpVisitor.toPixels(context, 16), 0);
        setTextSize(24);
    ...
    void setValid(boolean valid) {
        ...
        if (delegate != null) {
            delegate.onFieldValidityChanged();
        }
    }
    ...
    public abstract void checkValidity(final String text);
    ...
    public void setCursorDrawableColor(int color) {
        ...
        try {
            ...
            int cursorDrawableRes = cursorDrawableResField.getInt(this);
            ...
            drawables[0] = ContextCompat.getDrawable(getContext(), cursorDrawableRes);
            drawables[1] = ContextCompat.getDrawable(getContext(), cursorDrawableRes);
