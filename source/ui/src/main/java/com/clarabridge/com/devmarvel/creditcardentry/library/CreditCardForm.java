...
import com.clarabridge.com.devmarvel.creditcardentry.internal.CreditCardEntry;
...
public class CreditCardForm extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int style) {
        ...
        cardImageFrame.setPadding(10, 0, 0, 25);
        ...
        entry.setPadding(0, 0, 0, (int) DpVisitor.toPixels(context, 12));
